---
title: "Main lessons from 'The Art of Readable Code'"
date: 2025-12-07
category: Statistics, mathematics and computer science
layout: post
---

The objective of this guide is to compile the end-of-chapter summaries from ([Boswell and Foucher, 2011](#boswellfoucher2011)). The summaries do not replace the content of each chapter, but can be useful as quick reference points.

## Packing Information Into Names

The reader should be able to extract a lot of information just from reading the name. Here are some specific tips:
...
## Aesthetics
By “formatting” your code in a consistent, meaningful way, you make it easier and faster to read.
...
Here are specific tips about writing comments that pack as much information into as small a space as possible:
...
Giant expressions are hard to think about. There are a number of ways to break them down so the reader can digest them piece by piece.
...
You can make your code easier to read by having fewer variables and making them as “lightweight” as possible. Specifically:
- Eliminate variables that just get in the way. In particular, eliminate “intermediate result” variables by handling the result immediately.
...
**Separate the generic code from the project-specific code**. As it turns out, most code is generic. By building a large set of libraries and helper functions to solve the general problems, what’s left will be a small core of what makes your program unique.
...
Describe your program in plain English and use that description to help you write more natural code. This technique is deceptively simple, but very powerful. Looking at the words and phrases used in your description can also help you identify which subproblems to break off.
...
Writing as little new code as possible. Each new line of code needs to be tested, documented, and maintained. Further, the more code in your codebase, the “heavier” it gets and the harder it is to develop in.
...
- Give your test functions a fully descriptive name so it’s clear what each is testing. Instead of *Test1()*, use a name like *Test\_\<FunctionName>\_\<Situation>*.
